 <?php
    ...
    $user=$_POST['username'];
    $Email=$_POST['email'];
    // $interest1=$_POST["interest11"];
    // $interest2=$_POST["interest21"];
    // $wh_o=$_POST["stdent"];
    // $date=$_POST['date'];
    // $mytext= $_POST['myText'];
   ...
   // echo "ran".$s_contact;
    ...
    $searching_for= $_POST['i1'];
    $preferred_domain=$_POST['intrest'];
    ...
    $ClassXII_YrOfPassing=$_POST['classxii_yr'];
    ...
    $master_year_of_passing=$_POST['Masters_YrOfPassing'];
    echo $Graduation_YrOfPassing;
    ...
    if(!$conn)
       ...
       $sql= "CREATE DATABASE IF NOT EXISTS smart_intern3";//database name: bt20cse167
       $result=mysqli_query($conn,$sql);
       $database="smart_intern3";
...
//                UNIQUE  `8` (`user_name`)) ENGINE = InnoDB";
 ...
 $sql=   "CREATE TABLE IF NOT EXISTS  `smart_intern3`.`mytab1` ( `full_name` VARCHAR(10) NOT NULL ,  `username` VARCHAR(10) NOT NULL ,  `email` VARCHAR(30) NOT NULL ,  `phone_number` INT(10) NOT NULL , 
  `password` VARCHAR(255) NOT NULL ,  `r_password` VARCHAR(255) NOT NULL ,  `pincode` INT(8) NOT NULL ,  `region` VARCHAR(10) NOT NULL , 
   `gender` VARCHAR(10) NOT NULL ,  `searching_for` VARCHAR(10) NOT NULL ,  `preferred_domain` VARCHAR(10) NOT NULL ,  `board_x` VARCHAR(10) NOT NULL ,
     `percentage_x` DECIMAL(10) NOT NULL ,  `year_of_passing_x` INT NOT NULL ,  `board_xii` VARCHAR(10) NOT NULL ,  `percentage_xii` DECIMAL(10) NOT NULL ,  `year_of_passing_xii` 
     INT(10) NOT NULL ,  `graduation_board` VARCHAR(10) NOT NULL ,  `percentage_graduatio` DECIMAL(10) NOT NULL ,  `graduation_year_of_passing` INT(10) NOT NULL ,  `masters_board` VARCHAR(10) NOT NULL , 
      `masters_percentage` DECIMAL(10) NOT NULL ,  `masters_year_of_passing` INT(10) NOT NULL ) ENGINE = InnoDB";
      ...
      <form action="tp.php" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="rpass" placeholder="Confirm your password" required>
          </div>
        </div>
        <div class="input-box">
  ...
  <option value="West Bengal">West Bengal</option>
        ...
        <div class="gender-details">
          ...
          <div class="hobby-details">
            ...
            <input type="radio" value='prefer not to say' name="i1" id="dot-9">

            <span class="hobby-title">Searching for</span>
            <div class="category">
              <label for="dot-7">
            ...
            <label for="dot-9">
              ...
              <span class="hobby">Prefer not to say</span>
              </label>
            ...
            <div class="hobby-details">
              ...
              <input type="radio" value='prefer not to say' name="intrest" id="dot-10">


              <span class="hobby-title">Preferred domain</span>
              <div class="category">
                <label for="dot-4">
          ...
          <table>
            ...
            <td><input type="text" name="classxii_yr"  maxlength="30" /></td>
            </tr>
        ...
        <div class="button"> <a href="signin.php">  <input type="submit" value="Register"></a>
        </div>
        <div class="button">
